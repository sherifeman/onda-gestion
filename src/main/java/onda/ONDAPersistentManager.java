...
public class ONDAPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ONDA";
	...
	private ONDAPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ONDAPersistentManager();
		}
